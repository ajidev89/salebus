# SALEBUS INOVICING APP

Salebus is an open source invoicing app built with SB admin dashboard theme for [Bootstrap](https://getbootstrap.com/) created by [Start Bootstrap](https://startbootstrap.com/).
